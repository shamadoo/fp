...
import fpinscala.exercises.parallelism.Nonblocking._
import fpinscala.exercises.parallelism.Nonblocking.Par.toParOps // infix syntax for `Par.map`, `Par.flatMap`, etc
...
object Monoid {
  ...
  import fpinscala.exercises.testing._
  import Prop._
